...
![](STA_380_Homework_2_Adapalli_Fernandez_Malhotra_files/figure-markdown_strict/unnamed-chunk-3-2.png)
...
### Odds of Delay by Time of Year (in Months)
    ...
    barplot(odds_df_year$`Odds of Delay`,names.arg = odds_df_year$`Time of Year`,las=2,ylim = c(0,1),col = odds_df_year$Col,xlab = "Time of Year",ylab = "Odds of Delays")
